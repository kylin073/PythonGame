...
FRAME_PER_SEC = 60
# 创建敌机的定时器常量
CREATE_EMENY_EVENT = pygame.USEREVENT
# 英雄发射子弹事件
...
class GameSprite(pygame.sprite.Sprite):
    def __init__(self, image_name, speed = 1):
        ...
        # get_rect 返回 pygame.Rect(0,0,图像宽，图像高)的对象
...
class Background(GameSprite):
    ...
    def __init__(self, is_alt = False):
        # 用is_alt来判断图片位置，如果是False则是正好叠加在屏幕上方的
...
class Enemy(GameSprite):
    ...
    #内置方法会在对象被销毁前调用，在开发中可以用来判断对象是否被销毁
    """
    def __del__(self):
